...
* Note: You'll need to use `python -m http-server` initiated from command line to run the visualization. This will host the page at `localhost:8000` in your web browser. This is because the data is from a stored .csv file
